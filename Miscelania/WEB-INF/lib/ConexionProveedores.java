...
import java.io.*;
import Provedorees.Provedorees;
import java.util.Vector;

import javax.servlet.annotation.WebServlet;

@WebServlet("/Provedorees")

public class ConexionProveedores extends HttpServlet{
    public void doPost(HttpServletRequest request, HttpServletResponse response){
        try{
           ...
           Class.forName("com.mysql.jdbc.Driver");
            ...
            String diaDeEntrega=request.getParameter("DiadeEntrega");
            String nombre=request.getParameter("Nombre");
            String telefono=request.getParameter("Telefono");

            Statement stat = con.createStatement();

            String sql="INSERT INTO Proveedor(correo, diaDeEntrega, nombre, telefono) VALUES (‘"+correo+"‘,‘"+diaDeEntrega+"‘,‘"+nombre+"‘‘"+telefono+"‘)";
